...
public final class EMABlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<TieredMECraftingProviderBlockEntity>> XTREME_ME_CRAFTING_PROVIDER =
            BLOCK_ENTITIES.register("xtreme_me_crafting_provider",
                    () -> createProviderType(TieredMECraftingProviderTier.XTREME,
    ...
    private static BlockEntityType<TieredMECraftingProviderBlockEntity> createProviderType(
            TieredMECraftingProviderTier tier, TieredMECraftingProviderBlock block) {
    ...
    public static void registerRepresentativeItems() {
        AEBaseBlockEntity.registerBlockEntityItem(
                EXTENDED_MOLECULAR_ASSEMBLER.get(), EMAItems.EXTENDED_MOLECULAR_ASSEMBLER.get());
        AEBaseBlockEntity.registerBlockEntityItem(
                EX_EXTENDED_MOLECULAR_ASSEMBLER.get(), EMAItems.EX_EXTENDED_MOLECULAR_ASSEMBLER.get());
        AEBaseBlockEntity.registerBlockEntityItem(
                BASIC_ME_CRAFTING_PROVIDER.get(), EMAItems.BASIC_ME_CRAFTING_PROVIDER.get());
        AEBaseBlockEntity.registerBlockEntityItem(
                ADVANCED_ME_CRAFTING_PROVIDER.get(), EMAItems.ADVANCED_ME_CRAFTING_PROVIDER.get());
        AEBaseBlockEntity.registerBlockEntityItem(
                ELITE_ME_CRAFTING_PROVIDER.get(), EMAItems.ELITE_ME_CRAFTING_PROVIDER.get());
        AEBaseBlockEntity.registerBlockEntityItem(
                ULTIMATE_ME_CRAFTING_PROVIDER.get(), EMAItems.ULTIMATE_ME_CRAFTING_PROVIDER.get());
        AEBaseBlockEntity.registerBlockEntityItem(
                RE_AVARITIA_SCULK_ME_CRAFTING_PROVIDER.get(), EMAItems.RE_AVARITIA_SCULK_ME_CRAFTING_PROVIDER.get());
        AEBaseBlockEntity.registerBlockEntityItem(
                RE_AVARITIA_NETHER_ME_CRAFTING_PROVIDER.get(), EMAItems.RE_AVARITIA_NETHER_ME_CRAFTING_PROVIDER.get());
        AEBaseBlockEntity.registerBlockEntityItem(
                RE_AVARITIA_END_ME_CRAFTING_PROVIDER.get(), EMAItems.RE_AVARITIA_END_ME_CRAFTING_PROVIDER.get());
        AEBaseBlockEntity.registerBlockEntityItem(
                XTREME_ME_CRAFTING_PROVIDER.get(), EMAItems.XTREME_ME_CRAFTING_PROVIDER.get());
    }
